...
#if SIDE_EXIT_INITIAL_VALUE <= _Py_AdaptiveCoolDownValue
#  error  "Cold exit value should be larger than adaptive cooldown value"
#endif
//Ashok until here (need to be replaced with actual Adaptie cooldown value =ADAPTIVE_COOLDOWN_VALUE)
...
adaptive_counter_cooldown(void) {
    return adaptive_counter_bits(_Py_AdaptiveCoolDownValue,
                                 ADAPTIVE_COOLDOWN_BACKOFF);
}
//Ashok until here (need to be replaced with Adaptive Cool Down value)
static inline _Py_BackoffCounter
