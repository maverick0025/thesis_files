...
# sys.path.append(os.path.abspath(os.path.join(os.path.dirname(__file__), "../lib/pyxl")))
sys.path.append("/home/s265d007/Documents/projs/th/benchmarks-branch-default/lib/pyxl")
...
if __name__ == "__main__":
    ...
    parser = optparse.OptionParser(
        usage="%prog [options]",
        description="Test the performance of the pyxl benchmark")
