...
def _main():
    ...
    filename= "/home/s265d007/Documents/projs/th/benchmarks-branch-default/own/interpreter.tar.bz2"
    ...
    assert md5(out.encode('utf-8')).hexdigest() == "afa004a630fe072901b1d9628b960974"
    input.close()
